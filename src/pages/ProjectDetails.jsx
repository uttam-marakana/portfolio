...
export default function ProjectDetails() {
  ...
  const loading =
    Boolean(project?.github) && !(project.github in readmesByRepo);
    ...
    <PageTransition>
      <section className="px-3 pt-6 pb-8">
        <div className="page-shell">
          <div className="space-y-6 xl:grid xl:grid-cols-[minmax(0,1fr)] xl:gap-8 xl:space-y-0">
                ...
                <div className="premium-panel p-6 md:p-8">
                  <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                    ...
                    <p className="max-w-lg text-sm leading-7 text-(--text-2)">
                      Additional visuals used to make the case study feel closer
                      to the actual product surface, not just a single hero
                      image.
                    </p>
                  </div>
                ...
                >
                  <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                    ...
                    <p className="max-w-lg text-sm leading-7 text-(--text-2)">
                      ...
                      technical context, but the case study above carries the
                      main product and implementation story.
                    </p>
                  </div>
                  ...
                  <article className="premium-prose prose mt-10 max-w-none prose-headings:scroll-mt-32 prose-p:text-(--text-2) prose-li:text-(--text-2) prose-strong:text-(--text-1) prose-code:text-(--brand-1)">
                    {loading ? (
                      ...
                      <p className="text-(--text-2)">
                        This project does not expose a public README summary
                        here, so the case-study sections above carry the main
                        delivery context.
                      </p>
                    )}
                  </article>
